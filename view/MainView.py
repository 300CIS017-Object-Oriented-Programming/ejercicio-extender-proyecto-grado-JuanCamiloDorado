...
from view.EvaluacionActaPartial import ver_historico_acta, agregar_acta, evaluar_criterios, exportar_acta, ver_estadisticas
...
class MainView:
    ...
    def _dibujar_layout(self):
        ...
        with st.sidebar:
            ...
            self.menu_actual = option_menu("Menu", ["Inicio", 'Crear acta', 'Evaluar acta', 'Ver históricos', 'Exportar Acta', 'Estadisticas'],
